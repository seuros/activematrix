...
class URITest < ActiveSupport::TestCase
  def test_creation
    ...
    assert_equal ActiveMatrix::MXID.new('@her:example.org'), uri.mxid
    ...
    mxid = ActiveMatrix::MXID.new('!rid:example.org')
    ...
    mxid = ActiveMatrix::MXID.new('#us:example.org')
    ...
    assert_equal URI('matrix:roomid/rid:example.org/e/lol823y4bcp3qo4?via=example2.org'), mxid.to_uri(event_id: ActiveMatrix::MXID.new('$lol823y4bcp3qo4'), via: 'example2.org')
  end
