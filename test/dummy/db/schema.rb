...
ActiveRecord::Schema[8.0].define(version: 1) do
  create_table 'active_matrix_agent_stores', force: :cascade do |t|
    ...
    t.index %w[agent_id key], name: 'index_active_matrix_agent_stores_on_agent_id_and_key', unique: true
  ...
  create_table 'active_matrix_chat_sessions', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[agent_id user_id room_id], name: 'index_chat_sessions_on_agent_user_room', unique: true
